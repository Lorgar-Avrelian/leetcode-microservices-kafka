package lorgar.avrelian.task0021.service;
...
import lorgar.avrelian.task0021.model.ListNode;
import lorgar.avrelian.task0021.model.Task0021;
...
@Service
public class Task0021RunService implements TaskRunService<ListNode[], ListNode> {
    ...
    public Task0021RunService(KafkaSender<String, Object> kafkaSender, KafkaReceiver<String, Object> kafkaReceiver) {
    ...
    public TaskReport<ListNode[], ListNode> runTask() {
        Task0021 t = new Task0021(testValues);
