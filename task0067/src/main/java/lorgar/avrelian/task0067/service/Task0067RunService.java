package lorgar.avrelian.task0067.service;
...
import lorgar.avrelian.task0067.model.Task0067;
...
@Service
public class Task0067RunService implements TaskRunService<String[], String> {
    ...
    public Task0067RunService(KafkaSender<String, Object> kafkaSender, KafkaReceiver<String, Object> kafkaReceiver) {
    ...
    public TaskReport<String[], String> runTask() {
        Task0067 t = new Task0067(testValues);
