package lorgar.avrelian.task0083.service;
...
import lorgar.avrelian.task0083.model.ListNode;
import lorgar.avrelian.task0083.model.Task0083;
...
@Service
public class Task0083RunService implements TaskRunService<ListNode, ListNode> {
    ...
    public Task0083RunService(KafkaSender<String, Object> kafkaSender, KafkaReceiver<String, Object> kafkaReceiver) {
    ...
    public TaskReport<ListNode, ListNode> runTask() {
        Task0083 t = new Task0083(testValues);
