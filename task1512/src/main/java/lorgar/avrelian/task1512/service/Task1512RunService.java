package lorgar.avrelian.task1512.service;
...
import lorgar.avrelian.task1512.model.Task1512;
...
@Service
public class Task1512RunService implements TaskRunService<int[], Integer> {
    private static final TestValues<int[], Integer> testValues = new TestValues<>(
            Map.of(
                    new int[]{1, 2, 3, 1, 1, 3}, Integer.valueOf(4),
                    new int[]{1, 1, 1, 1}, Integer.valueOf(6),
                    new int[]{1, 2, 3}, Integer.valueOf(0)
            )
    );
    @Value("${task.number}")
    ...
    public Task1512RunService(KafkaSender<String, Object> kafkaSender, KafkaReceiver<String, Object> kafkaReceiver) {
    ...
    public TaskReport<int[], Integer> runTask() {
        Task1512 t = new Task1512(testValues);
